...
var UserServiceValidate = validator.New()
...
func RegisterUserServiceHttpHandler(g *gin.RouterGroup, srvs UserService) {
	...
	g.GET("/user/v1/:id", tmp.GetUserInfo)
	g.GET("/user/v1/:id/download", tmp.GetUserInfoDownload)
...
// @Tags    User-Service
// @Produce json
// @Param   page      -        page      query uint32 true "页码"
// @Param   page_size -        page_size query uint32 true "每页数量"
...
func (x *x_UserService) GetUsers(ctx *gin.Context) {
	...
	if err := UserServiceValidate.Struct(req); err != nil {
...
// @Tags    User-Service
// @Produce json
// @Param   data body     User true "body 参数"
...
// @Failure 401 {string} string "header need Authorization data"
// @Failure 403 {string} string "no api permission or no obj permission"
// @Router  /user/v1/:id/download [GET]
